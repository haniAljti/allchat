...
class FileXmppDataSource(
    ...
    val filesUploadProgress: SharedFlow<MutableMap<Any, UploadProgress>> get()  = _filesUploadProgress

    fun upload(file: File, identifier: Any = file): CallResult<String> {
